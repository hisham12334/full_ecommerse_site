...
const PurchaseSection = () => {
  ...
  if (!product) {
    // Fallback for when backend is not available (deployment)
          ...
          >
            ...
            <div className="mb-8">
              <p className="font-serif text-5xl font-semibold text-charcoal">
                ₹{parseFloat(fallbackProduct.price).toLocaleString()}
              </p>
            ...
            <button
              ...
              onClick={() => alert('Backend not connected. This is a demo version.')}
